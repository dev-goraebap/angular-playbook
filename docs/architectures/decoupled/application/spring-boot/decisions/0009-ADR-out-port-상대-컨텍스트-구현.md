...
title: 'ADR-0009: out port를 상대 컨텍스트가 구현할 수 있다'
...
| **기각 사유** | 기각이 아니라 **먼저 검토할 선택지**입니다. [컨텍스트 협력](../concepts/컨텍스트-협력.md) 3절의 세 질문에서 경계가 실재하지 않는 것으로 판정되면 합치는 편이 맞습니다. 본 ADR 은 경계가 실재한다고 판정된 뒤의 수단입니다 |
