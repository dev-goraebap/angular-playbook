 ...
 * 기각한 대안과 감수하는 대가는 external/refarch-angular-springboot/docs/architecture/angular/decisions/0046-doc-typography.md 가 원본입니다.
 */
 ...
 * 근거는 external/refarch-angular-springboot/docs/architecture/angular/references/rendering.md 2절에 있습니다.
 */
