 ...
 * 기각한 대안과 감수하는 대가는 external/refarch-angular-springboot/docs/architecture/angular/decisions/0015-ADR-문서-타이포그래피-프리셋.md 가 원본입니다.
 */
 ...
 * 근거는 external/refarch-angular-springboot/docs/architecture/angular/references/렌더링-전략.md 2절에 있습니다.
 */
